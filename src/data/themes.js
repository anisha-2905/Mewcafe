...
export const themes = [
  {
    ...
    ambiencePath: './sounds/spring-ambience.mp3',
    accentColor: '#ff92bd',
    buttonColor: '#ffd59a',
  ...
  },
  {
    ...
    ambiencePath: './sounds/rainy-ambience.mp3',
    accentColor: '#8fc2cc',
    buttonColor: '#6f9aa5',
  ...
  },
  {
    ...
    ambiencePath: './sounds/autumn-ambience.mp3',
    accentColor: '#f08a3c',
    buttonColor: '#c9672e',
  ...
  },
  {
    ...
    ambiencePath: './sounds/christmas-ambience.mp3',
    accentColor: '#f7c56b',
    buttonColor: '#8f4f62',
